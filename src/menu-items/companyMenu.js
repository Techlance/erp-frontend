  ...
  children: [
    {
      ...
      children: [
          ...
          children: [
            {
              ...
              type: "item",
              url: `/company/:mid/:year_id/master/ledger-master/head`,
            },
            {
              id: "group",
              title: <FormattedMessage id="menu.group" />,
              type: "item",
              url: "/company/:mid/:year_id/master/ledger-master/group",
            },
            {
              id: "ledger",
              title: <FormattedMessage id="menu.ledger" />,
              type: "item",
              url: "/company/:mid/:year_id/master/ledger-master/ledger",
            },
            {
              id: "opening-balance",
              title: <FormattedMessage id="menu.opening-balance" />,
              type: "item",
              url: "/company/:mid/:year_id/master/op-bal-brs",
            },
          ],
        },
        {
          ...
          children: [
            {
              ...
              type: "item",
              url: `/company/:mid/:year_id/master/cost-center/category`,
            },
            {
              id: "cost-center",
              title: <FormattedMessage id="menu.cost-center" />,
              type: "item",
              url: `/company/:mid/:year_id/master/cost-center/center`,
            },
          ],
        },
        {
          ...
          type: "item",
          url: "/company/:mid/:year_id/master/budget",
          // url: "/company/:mid/:year_id/master/budget",
          // children: [
          //   {
          //     id: "pl-budget",
          ...
          //     type: "item",
          //     // url: "/company/:mid/:year_id/master/budget/pl/:bid",
          //     url: "/company/:mid/:year_id/master/budget",
          //   },
          //   {
          //     id: "cash-flow-budget",
          ...
          //     type: "item",
          //     // url: "/company/:mid/:year_id/master/budget/cashflow/:bid",
          //     url: "/company/:mid/:year_id/master/budget",
          //   },
          // ],
        },
        {
          ...
          type: "item",
          url: "/company/:mid/:year_id/master/voucher-type",
        },
        {
          id: "currency",
          title: <FormattedMessage id="menu.currency" />,
          type: "item",
          url: "/company/:mid/:year_id/master/currency",
          breadcrumbs: true,
        },
        {
          id: "lc",
          ...
          type: "collapse",
          // url: `/company/:mid/:year_id/master/lc/import`,
          children: [
            {
              id: "import",
            ...
            },
            {
              ...
              type: "item",
              url: `/company/:mid/:year_id/master/lc/export`,
            },
          ],
        },
      ],
